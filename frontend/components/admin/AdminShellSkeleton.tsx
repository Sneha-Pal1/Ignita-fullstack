export const AdminShellSkeleton = () => {
  return (
    <div className="flex min-h-screen bg-zinc-950 animate-pulse">
      <aside className="hidden lg:flex fixed left-0 top-0 h-screen w-64 flex-col border-r border-zinc-800 bg-zinc-950">
