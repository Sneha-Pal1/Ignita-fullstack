...
export function CategoryInsights({ categories }: CategoryInsightsProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      {/* Top Category Card */}
      <div
        className={`p-6 rounded-xl border ${colors.bg} border-${topCategory.color}-500/30 flex flex-col justify-center items-start`}
      >
