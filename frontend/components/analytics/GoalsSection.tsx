...
import { goalsData } from '@/lib/data/analytics';
import { Flame, Target } from 'lucide-react';

export function GoalsSection() {
  // Calculate current streak (mock)
  const currentStreak = 7;
  const streakRecord = 14;
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-6 bg-gradient-to-br from-amber-600/30 to-amber-900/30 border border-amber-500/30 rounded-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-xs font-medium text-amber-300">Current Streak</p>
          ...
          <div className="p-6 bg-zinc-800/50 border border-zinc-700 rounded-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-white">{streakRecord} days</p>
              </div>
            </div>
          ...
          <div className="p-6 bg-emerald-600/20 border border-emerald-500/30 rounded-xl">
            <div className="flex items-center gap-3 mb-4">
              <div className="text-3xl">⚡</div>
              <div>
                <p className="text-xs font-medium text-emerald-300">Engagement Score</p>
                <p className="text-2xl font-bold text-white">84/100</p>
              </div>
            </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          {goalsData.map((goal) => (
            <div key={goal.title} className="p-5 bg-zinc-900 border border-zinc-800 rounded-xl">
