...
const getIntensityColor = (
  ...
  const colorMap = {
    ...
    medium:
      "bg-emerald-800/60 hover:bg-emerald-800/80 border border-emerald-600/40",
...
export function ActivityHeatmap({
  ...
  // Ensure we have 365 items; if not, return empty weeks
  if (data.length > 0) {
    data.forEach((item) => {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-400">
          Your contribution activity over the past year. Darker green means more
          engagement.
        </p>
      </div>
